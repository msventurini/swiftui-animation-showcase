...
internal struct SectionGeometryData {
    ...
    internal init(console: HandheldConsoleContainer, consoleSection: ConsoleSection.SectionID) {
    ...
    private static func sliceOriginPosition(console: HandheldConsoleContainer, consoleSection: ConsoleSection.SectionID) -> CGRectEdge {
    ...
    private static func sizeProportion(console: HandheldConsoleContainer, consoleSection: ConsoleSection.SectionID) -> Double {
